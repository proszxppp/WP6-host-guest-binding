...
For the chemical structures presented in paper 1, there is a typo: G3 has a -NH3+ group rather than -NMe3+, but the chemical structures uploaded here (the current repository) are correct. 
